        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers("/ping", "/health/**", "/graduates", "/auth/login")
                    ...
                    .hasAnyRole(STUDENT.name(), TEACHER.name(), ADMIN.name())
                    .requestMatchers(
                        new GradeSelfMatcher(GET, "/api/grades/*", "grades", gradeRepository))
                    .hasRole(STUDENT.name())
                    .requestMatchers(GET, "/api/grades/*")
                    .hasAnyRole(TEACHER.name(), ADMIN.name())
                    .requestMatchers(
                        new GradeSelfMatcher(
                            GET, "/api/grades/*/history", "grades", gradeRepository))
                    .hasRole(STUDENT.name())
                    .requestMatchers(GET, "/api/grades/*/history")
                    .hasAnyRole(TEACHER.name(), ADMIN.name())
                    ...
                    .requestMatchers(GET, "/api/exams/*")
                    .authenticated()
                    .requestMatchers(POST, "/api/exams")
                    .hasAnyRole(TEACHER.name(), ADMIN.name())
                    .requestMatchers(PUT, "/api/exams/*")
                    .hasAnyRole(TEACHER.name(), ADMIN.name())
